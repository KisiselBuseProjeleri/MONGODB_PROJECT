...
from şirket_veri_tabanı.employee_db import EmployeeDB
from şirket_veri_tabanı.inventory_db import InventoryDB
def main():
    ...
    inventory_db.update_inventory_bulk({'qty':{'$lt':50}},{'size.uom':'inch','status':'P'})#mikarı 50'den az olanın size uom ismini inh yapın ve statusu p ile değiştirin.
